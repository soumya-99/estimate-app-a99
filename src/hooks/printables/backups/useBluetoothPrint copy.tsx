...
export const useBluetoothPrint = () => {
  async function printReceipt(
    ...
    try {
      ...
      await BluetoothEscposPrinter.printPic(BASE_64_IMAGE, {
        width: 300,
        align: "center",
        left: 30,
      })
      ...
      await BluetoothEscposPrinter.printText("\n", {})
      await BluetoothEscposPrinter.printText("CASH RECEIVED:       500", {
        align: "center",
      })
      await BluetoothEscposPrinter.printText("\n", {})
      await BluetoothEscposPrinter.printText("RETURNED AMT:        186", {
        align: "center",
      })
